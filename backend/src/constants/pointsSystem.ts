...
export const DEFAULT_POINT_RULES: PointActionRule[] = [
  ...
  { id: 'exchange_question', label: 'Задать вопрос в «Обмене опытом»', section: 'exchange', pointsPerAction: 3, maxTotal: 30, maxCount: 10, countsToReflection: true, note: 'Лимит — 10 вопросов за форум' },
  { id: 'exchange_answer', label: 'Ответить на чужой вопрос', section: 'exchange', pointsPerAction: 3, maxTotal: 45, maxCount: 15, countsToReflection: true, note: 'Лимит — 15 ответов за форум' },
