...
Frontend: Timeweb (статика из frontend/dist)
...
4. npm run build:frontend:prod                # -> frontend/dist
5. Upload frontend/dist to Timeweb static hosting
6. dev.vk.com -> Размещение = URL фронта Timeweb (see deploy/VK_CABINET_CHECKLIST.md)
